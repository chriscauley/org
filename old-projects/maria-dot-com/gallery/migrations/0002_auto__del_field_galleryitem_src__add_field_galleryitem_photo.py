...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'GalleryItem.src'
        db.rename_column('gallery_galleryitem', 'src_id','photo_id')

    def backwards(self, orm):
        # Renaming field 'GalleryItem.photo'
        db.rename_column('gallery_galleryitem', 'photo_id','src_id')
