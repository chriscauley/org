...
CKEDITOR.plugins.add(
	...
	init : function( editor )
	{
	    ...
	    if ( !CKEDITOR.env.hc )
	    {
		addButton( 'FontColor', 'fore', lang.textColorTitle );
		...
		editor.ui.add(
		    name, CKEDITOR.UI_PANELBUTTON,
		    {
			label : title,
			title : title,
			className : 'cke_button_textcolor', //+ name.toLowerCase(),
			modes : { wysiwyg : 1 },
...
CKEDITOR.config.colorButton_colors =
    "f39899,a53439,f89d41,68a15e,f1593d,000000,FFFFFF";
    /*'AA0000,800000,8B4513,2F4F4F,008080,000080,4B0082,696969,' +
