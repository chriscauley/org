...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Site'
        db.create_table('spider_site', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('venue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geo.Venue'])),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('url_selector', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('default_start_time', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('ticket_selector', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('spiderurl', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('date_selector', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('date_strptime', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
            ('date_regexp', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
            ('band_selector', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('band_splitters', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
        ))
        db.send_create_signal('spider', ['Site'])


    def backwards(self, orm):
        
        # Deleting model 'Site'
        db.delete_table('spider_site')
    ...
    models = {
        ...
        'spider.site': {
            ...
            'band_selector': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'band_splitters': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'date_regexp': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'blank': 'True'}),
            'date_selector': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'date_strptime': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'blank': 'True'}),
            'default_start_time': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
