...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Song.track'
        db.delete_column('music_song', 'track')

        # Adding field 'Song.order'
        db.add_column('music_song', 'order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Song.track'
        db.add_column('music_song', 'track', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Song.order'
        db.delete_column('music_song', 'order')
