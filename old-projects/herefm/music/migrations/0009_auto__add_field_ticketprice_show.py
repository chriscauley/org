...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TicketPrice.show'
        db.add_column('music_ticketprice', 'show', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['music.Show']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TicketPrice.show'
        db.delete_column('music_ticketprice', 'show_id')
