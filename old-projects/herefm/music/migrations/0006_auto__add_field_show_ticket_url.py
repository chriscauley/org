...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Show.ticket_url'
        db.add_column('music_show', 'ticket_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Show.ticket_url'
        db.delete_column('music_show', 'ticket_url')
