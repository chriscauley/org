...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Song.band'
        db.add_column('music_song', 'band', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.Band'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Song.band'
        db.delete_column('music_song', 'band_id')
