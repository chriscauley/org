...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Song.dummy'
        db.add_column('music_song', 'dummy', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Song.dummy'
        db.delete_column('music_song', 'dummy')
    ...
    models = {
        ...
        'music.appearance': {
            'Meta': {'ordering': "('order',)", 'object_name': 'Appearance'},
