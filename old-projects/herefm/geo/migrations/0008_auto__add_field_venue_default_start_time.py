...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Venue.default_start_time'
        db.add_column('geo_venue', 'default_start_time', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Venue.default_start_time'
        db.delete_column('geo_venue', 'default_start_time')
