...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('artist_performance', 'order', self.gf('django.db.models.fields.IntegerField')(default=9999), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Performance.order'
        db.delete_column('artist_performance', 'order')
    ...
    models = {
        ...
        'artist.performance': {
            'Meta': {'ordering': "('order',)", 'object_name': 'Performance'},
