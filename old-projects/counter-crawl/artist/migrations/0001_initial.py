...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('artist_performance', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('medium', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal('artist', ['Performance'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('artist_performance')
