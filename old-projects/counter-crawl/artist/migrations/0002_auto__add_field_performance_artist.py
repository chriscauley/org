...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Performance.artist'
        db.add_column('artist_performance', 'artist', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['artist.Artist']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Performance.artist'
        db.delete_column('artist_performance', 'artist_id')
    ...
    models = {
        ...
        'artist.performance': {
            ...
            'medium': ('django.db.models.fields.CharField', [], {'max_length': '64'})
        },
        'event.event': {
